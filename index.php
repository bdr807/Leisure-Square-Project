...
<div class="parallax" onclick="remove_class()">
	...
	<div class="parallax_head">
		...
		<h2>Welcome</h2>
		<h3>Make Your Party With Delicious Dishes</h3>
	...
	<div class="inner_content">
		...
		<div class="contact">
			...
			<div class="left">
				...
				<h3>LOCATION</h3>
				<p>178/6 14th main road, 20th, 50th Main Rd, Kumaraswamy Layout</p>
			...
			<div class="left">
				...
				<h3>CONTACT</h3>
				<p>Ph NO-6366304818</p>
				<p>Mail-id-leisuresquare8384@gmail.com</p>
